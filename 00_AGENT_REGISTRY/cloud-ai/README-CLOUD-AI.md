...
4. `05_HANDOFFS/projects/<SLUG>/CLOUD_AI_ENTRY.md` — project-specific discipline
5. `05_HANDOFFS/projects/<SLUG>/planning/INTAKE.md` and existing planning files
...
- **Gemini / ChatGPT** — strategy, decomposition, Architect Pack 001
