# NotebookLM — single GitHub entry point

**Repository:** `shaneturon3-web/ControlTower`  
**Use this file** when adding one GitHub/raw source to NotebookLM.

The full manual below matches `04_GLOBAL_RULES/NOTEBOOKLM-ARCHITECTURE-SPECIFICATION.md` (Drive canonical copy).
